...
const translations = {
  ru: {
    ...
    supportLead: 'Выберите направление обращения. Пока здесь указаны моковые контакты, их можно заменить перед финальным запуском.',
    supportCards: [
      {
      ...
      },
      {
        ...
        phone: '+7 771 000 24 24',
        email: 'support@peshekhod.kz',
        address: 'г. Уральск, пр-т Абулхаир Хана, 2/11'
      }
    ],
    ...
    policy: [
      ...
      ['1. Общие положения', '1.1. Компания осуществляет обработку персональных данных в соответствии с законодательством Республики Казахстан. 1.2. Политика распространяется на всех пользователей сервиса доставки, включая клиентов, получателей заказов, курьеров, партнеров и представителей бизнеса. 1.3. Персональные данные обрабатываются исключительно для оказания услуг доставки и улучшения работы сервиса.'],
      ['2. Компания может собирать следующие данные', '2.1. Данные пользователя: ФИО, номер телефона, адрес доставки, адрес электронной почты, согласие на звонки и SMS, данные аккаунта, история заказов, комментарии к заказам. 2.2. Технические данные: IP-адрес, данные устройства, cookies, сведения о браузере и операционной системе, геолокация при разрешении пользователя. 2.3. Платежные данные: при оплате онлайн данные банковской карты могут обрабатываться платежными системами. Компания не хранит полные данные банковских карт пользователей.'],
      ...
      ['5. Хранение и защита данных', '5.1. Компания принимает необходимые организационные и технические меры для защиты персональных данных от утраты, неправомерного доступа, изменения и распространения. 5.2. Данные хранятся не дольше, чем это необходимо для целей их обработки или в сроки, установленные законодательством Республики Казахстан.'],
      ...
      ['9. Контактная информация', 'ТОО «ПЕШЕХОД». Юр/фак адрес: г. Уральск, ул. Кайрата Жумагалиева, 16Б. БИН: 210540021826. Счет (KZT): KZ 786010181000283671. АО «Народный Банк Казахстана» г. Уральск. БИК: HSBKKZKX. Тел: 8 (7112) 50-70-67, 21-03-72.'],
  ...
  kz: {
    ...
    supportLead: 'Өтініш бағытын таңдаңыз. Әзірге мұнда тестілік байланыс деректері көрсетілген, финал алдында ауыстыруға болады.',
    supportCards: [
      {
      ...
      },
      {
        ...
        phone: '+7 771 000 24 24',
        email: 'support@peshekhod.kz',
        address: 'Орал қ., Әбілқайыр хан даңғылы, 2/11'
      }
    ],
